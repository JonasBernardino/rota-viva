...
Route::get('/mapa-da-cidade', CityMapController::class)
    ->name('city-map');
...
|
| DashboardController:
| responsável pelos indicadores, comportamento dos visitantes,
| demanda não atendida e mapa de calor.
|
| AdminController:
| responsável pelos CRUDs administrativos.
|
*/
